...
// node flow== exeution flow
 ...
 function deSerializeCue(meta,linker) {
//for each word in meta,for which we have a root,  we create the Cues as given breaking the word name in to cuepath and word name,placing the parent pointer 
//the parent should already being placed a object because meta is sorted ascending, the linker gives the cue paths // question is is linker useful in reconstruction,
//except  for rebuilding the environment 
...
//metawords is a dictionary of all words that can occur  in any name space cteated within WWW. All words ,including the words in the name  of the will belong to metawords.
 ...
 WWW.prototype.metaWords.values  = new Array(); //holds constant values for words or object values for cue words
