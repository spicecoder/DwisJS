...
<button onclick="flowCue();"> Flow with  Selected Cue </button>  
 ...
 /**************************DOCUMENT READY  *****************************************************************/
 function localStoreWWW( ) {
if (typeof window.localStorage != "undefined") {
var wo = new Object();
var vv = "{helloooo:darling}";
wo.a ="Peter";
wo.b = "Hon";
 
    localStorage.removeItem("WWW");
    // store
    localStorage.setItem("WWW",vv);
 }
...
if (typeof window.localStorage != "undefined") {
    ...
    // store
  var x =   localStorage.getItem("WWW");
...
//});
 ...
 $("#myWords").val(indict);
 addDict();
 LoadputinCue('Australia','root.Southern_Hemisphere');
 LoadputinCue('NSW','root.Southern_Hemisphere.Australia');
 LoadputinCue('Sydney','root.Southern_Hemisphere.Australia.NSW');
 LoadputinCue('Victoria','root.Southern_Hemisphere.Australia');
 LoadputinCue('SA','root.Southern_Hemisphere.Australia');
 LoadputinCue('Adelaide','root.Southern_Hemisphere.Australia.SA');
 LoadputinCue('MtGambier','root.Southern_Hemisphere.Australia.SA');
 LoadputinCue('Melbourne','root.Southern_Hemisphere.Australia.Victoria');
 LoadputinCue('Mildura','root.Southern_Hemisphere.Australia.Victoria');
 LoadputinCue('TravelPlan','root.WorldCup');
 LoadputinCue('Sydney','root.WorldCup.TravelPlan');
 LoadputinCue('Breakfast','root.WorldCup.TravelPlan.Sydney');
 LoadputinCue('Mildura','root.WorldCup.TravelPlan');
 LoadputinCue('Dinner','root.WorldCup.TravelPlan.Mildura');
 LoadputinCue('Adelaide','root.WorldCup.TravelPlan'); 
 LoadputinCue('Breakfast_Again','root.WorldCup.TravelPlan.Adelaide'); 
